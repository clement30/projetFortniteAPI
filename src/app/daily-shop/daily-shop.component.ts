...
export class DailyShopComponent implements OnInit {
  ...
  minutesLeft: number = 60 - this.minutesNow; //nbr de minutes jusqu'à la prochiane heure
  secondesLeft: number = 60 - this.secondesNow; //nbr de seconde jusqu'à la prochiane minute
  countDown: number = (this.hoursLeft*3600) + (this.minutesLeft*60) + this.secondesLeft; //secondes restantes jusqu'à 1h du matin
